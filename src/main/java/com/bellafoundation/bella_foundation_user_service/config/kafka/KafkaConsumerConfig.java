...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String,String> consumerFactory(){
        ...
        props.put(ConsumerConfig.FETCH_MAX_BYTES_CONFIG,"60000000");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);

        props.put("sals.mechanism",salsMechanism);
        props.put("sasl.jaas.config",salsJaasConfig);
        props.put("security.protocol",securityProtocal);
        props.put("use.type.headers",false);
